        ...
        <div className="baiviet-page">
            ...
            <div className="baiviet-container container">
                <div className="baiviet-header">
                    <h3>Tất cả bài viết <span>(128)</span></h3>
                    <div className="baiviet-sort">
                        Sắp xếp: {" "}
                        <button onClick={() => setSortKey("newest")} style={{ fontWeight: sortKey === "newest" ? 700 : 400 }}>Mới nhất</button>
                        {" "}|{" "}
                        <button onClick={() => setSortKey("oldest")} style={{ fontWeight: sortKey === "oldest" ? 700 : 400 }}>Cũ nhất</button>
                    </div>
                </div>

                <div className="baiviet-list">
                    {posts.map((post, index) => (
                        <Link key={index} to={`/bai-viet/${post.id}`} className="baiviet-card" style={{ textDecoration: "none" }}>
                            <img
                                src={post.image}
                                alt={post.title}
            ...
            <footer className="baiviet-footer">
                <div className="footer-content container">
                    <h3>MANKAI ACADEMY - HỌC VIỆN ĐÀO TẠO PHÁT TRIỂN TIỀM NĂNG THỰC CHIẾN</h3>
